...
| Dataset | Actual Coverage | Spatial Resolution | Temporal Resolution | Completeness | Status | Main Issue |
|---------|-----------------|--------------------|---------------------|--------------|--------|------------|
...
### 3. GIS
- **File**: `ERA5/wards_ahmedabad.geojson`
...
- `data/profiles/era5land_ahmedabad_2010_03.json`
- `data/profiles/gis_ahmedabad_wards.json`
- `data/profiles/cpcb_ahmedabad_2025_01_05.json`
- `docs/data/era5land_ahmedabad_2010_03.md`
- `docs/data/ahmedabad-gis-profile-v1.md`
- `docs/data/ahmedabad-temporal-availability-v1.md`
- `docs/data/ahmedabad-spatial-reconciliation-v1.md`
- `docs/data/ahmedabad-pilot-profile-v1.md`
