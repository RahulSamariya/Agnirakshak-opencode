"""
Corrected V2 Experiment with Proper Protocol
=============================================
Reruns V2 with StandardScaler + max_depth=10 to match original frozen baseline.
"""
...
print("=" * 70)
print("CORRECTED V2 EXPERIMENT WITH PROPER PROTOCOL")
print("=" * 70)
...
# ============================================================
# 3. CORRECTED LOSO VALIDATION
# ============================================================

print("[3/6] Corrected LOSO validation (StandardScaler + max_depth=10)...")
print("-" * 70)

def loso_validate_corrected(X, y, stations, model_class, model_params, experiment_name):
    """LOSO with StandardScaler inside fold (corrected protocol)."""
    ...
    for station in unique_stations:
        ...
        # Corrected: StandardScaler inside fold
...
v1_rf_corrected = loso_validate_corrected(X_v1, y, stations, RandomForestRegressor, rf_params_corrected, "V1_RF_corrected")
v1_gbm_corrected = loso_validate_corrected(X_v1, y, stations, GradientBoostingRegressor, gbm_params_corrected, "V1_GBM_corrected")
v1_ridge_corrected = loso_validate_corrected(X_v1, y, stations, Ridge, ridge_params, "V1_Ridge_corrected")
print()

# Train corrected V2 models
print("Training corrected V2 models...")
v2_rf_corrected = loso_validate_corrected(X_v2, y, stations, RandomForestRegressor, rf_params_corrected, "V2_RF_corrected")
v2_gbm_corrected = loso_validate_corrected(X_v2, y, stations, GradientBoostingRegressor, gbm_params_corrected, "V2_GBM_corrected")
v2_ridge_corrected = loso_validate_corrected(X_v2, y, stations, Ridge, ridge_params, "V2_Ridge_corrected")
print()
...
new_rows = [
    {
        ...
        'n': 500,
        'notes': 'Corrected protocol: StandardScaler + max_depth=10'
    },
    {
        'experiment': 'V2_corrected',
        'features': 'ERA5+engineered',
...
print("  Original frozen baseline used:")
print("    - StandardScaler inside each fold")
print("    - max_depth=10 for RandomForest")
print("  Feature-engineering experiment used:")
print("    - No StandardScaler")
print("    - No max_depth limit (unlimited depth)")
print("  This caused RMSE to increase from 15.75 to 16.40")
print("  and R2 to increase from 0.500 to 0.552")
print()
